...
/*
  Create a constructor function called CarFactory that will build car objects with 
  make and model properties.
  The values for the make and model will come from two parameters, 
  make and model (in that order).
*/
...
function Employee(name, email, hireDate) {
  ...
  */
  ...
  /*
    Write a constructor function, including method definitions, 
    which will make the above function invocations function properly.
  
    Hint: you'll need to add a move property,
      with a starting value of zero, and write a moveCar function 
      which will increment the move property by 10.
    The move property will be added to every object that is being returned 
    from the Car function.
  ...
  */
  ...
  /*
    Here we have a constructor function named Movie that takes in 3 parameters:
      ...
      (a number withing 1-100 that has been averaged out from previous given ratings).
...
Movie.prototype.changeRating = function(num) {
  ...
  // Write a constructor function called User. This function should take in 4 
  //parameters called name, age, email, and savedPosts in that order. 
  //Name and email will be strings, age will be a number and savedPosts will be 
  //an array of objects. These objects will each have 3 properties: 
  //id (a number), title (a string), and rating (a number between 1 and 5). 
  //These objects are the posts that the user will have saved to their account.
  
  // Once the User constructor function is created, write a prototype method for the 
  //User function. Name this method addSavedPost. 
  ...
  // Write a prototype method for the User constructor function named 
  //changePostRating that will take in two number parameters. 
  ...
  //Once you find the matching object, update it's rating score with the 
  //new rating parameter.
